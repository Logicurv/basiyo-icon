...
type INameProps = Omit<React.SVGProps<SVGSVGElement>,"name"> & {name:IconNames}
export default function Icon({name,...otherProps}:INameProps){
    const d = kebabToPascalCase(name)
    const Component = AllGeneratedIcons[d] as (_props: React.SVGProps<SVGSVGElement>) => JSX.Element
